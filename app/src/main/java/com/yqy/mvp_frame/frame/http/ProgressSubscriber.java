...
import com.yqy.mvp_frame.frame.ui.AbstractActivity;
import com.yqy.mvp_frame.frame.utils.JsonUtil;
...
//            ((AbstractActivity) mContext).showToast(errorMap.get("errorCode") + "：" + errorMap.get("errorMsg"));
        }else {
//            ((AbstractActivity) mContext).showSnackbar(e.getMessage());
//            ((AbstractActivity) mContext).showToast(e.getMessage());
